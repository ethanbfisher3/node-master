...
const TEST_VIDEO_AD_UNIT_ID = Platform.select({
  android: "ca-app-pub-3940256099942544/1033173712",
  ios: "ca-app-pub-3940256099942544/4411468910",
  default: null,
})
const envVideoAdUnitId =
  Platform.OS === "android"
    ? (process.env.EXPO_PUBLIC_ADMOB_VIDEO_AD_ID_ANDROID ??
      process.env.EXPO_PUBLIC_ADMOB_INTERSTITIAL_AD_ID_ANDROID ??
      process.env.EXPO_PUBLIC_ADMOB_REWARDED_INTERSTITIAL_AD_ID_ANDROID)
    : Platform.OS === "ios"
      ? (process.env.EXPO_PUBLIC_ADMOB_VIDEO_AD_ID_IOS ??
        process.env.EXPO_PUBLIC_ADMOB_INTERSTITIAL_AD_ID_IOS ??
        process.env.EXPO_PUBLIC_ADMOB_REWARDED_INTERSTITIAL_AD_ID_IOS)
      : null
const videoAdUnitId = __DEV__ ? TEST_VIDEO_AD_UNIT_ID : envVideoAdUnitId
